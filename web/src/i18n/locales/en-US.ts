export default {
    ...
    config: {
        ...
        localStorage: {
            ...
            clear: "Clear",
            clearAll: "Clear all",
            clearStore: "Clear {{name}}",
            clearStoreTitle: "Clear “{{name}}”?",
            clearStoreDescription: "All records in this object store will be permanently deleted. Continue?",
            clearAllTitle: "Clear all local storage?",
            clearAllDescription: "All Infinite Canvas local data will be permanently deleted, including configuration, canvases, assets, generation history, and prompt cache. Continue?",
            cleared: "Cleared {{name}}",
            clearedAll: "All local storage cleared",
            clearFailed: "Failed to clear local storage",
        ...
        channelEditor: {
            ...
            applyKey: "Get API key",
            keyDescription: "Paste it above after applying; the key stays in this browser.",
