export default {
    ...
    config: {
        ...
        localStorage: {
            ...
            clearAll: "清空所有",
            clearStore: "清空{{name}}",
            clearStoreTitle: "清空「{{name}}」？",
            clearStoreDescription: "该对象仓库中的所有记录都会被永久删除，确定继续吗？",
            clearAllTitle: "清空所有本地存储？",
            clearAllDescription: "Infinite Canvas 的本地数据都会被永久删除，包括配置、画布、资产、生成记录和提示词缓存。确定继续吗？",
            cleared: "已清空{{name}}",
            clearedAll: "已清空所有本地存储",
            clearFailed: "清空本地存储失败",
        ...
        channelEditor: {
            ...
            baseUrl: "接口地址",
            applyKey: "申请 API Key",
            keyDescription: "申请完成后粘贴到上方；Key 只保存在当前浏览器。",
            models: "渠道模型",
